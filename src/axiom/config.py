...
# This file is the SINGLE SOURCE OF TRUTH for all important project paths.
# All other modules should import their paths from here.

# 1. Find the project root directory by navigating up from this file's location.
#    config.py -> axiom -> src -> PROJECT_ROOT
THIS_FILE: Final = Path(__file__).resolve()
PROJECT_ROOT: Final = THIS_FILE.parent.parent.parent

# 2. Define all core directories relative to the project root.
