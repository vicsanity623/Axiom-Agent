...
class CognitiveAgent:
    ...
    def chat(self, user_input: str) -> str:
        ...
        if intent == "greeting":
            structured_response = "Hello User."
        elif intent == "farewell":
            structured_response = "Goodbye User."
        elif intent in ["gratitude", "acknowledgment"]:
            structured_response = "You're welcome!"
        elif intent == "positive_affirmation":
            ...
            # 1. Get a complete list of all edges by reconstructing them into our custom objects.
            # This is the most reliable way to ensure all attributes (like .weight) are present.
            reconstructed_edges = []
            ...
            if not reconstructed_edges:
                ...
                for edge in sorted_edges:
                    # 3. Now filter these reliable objects. This will work correctly.
            ...
            if "agent" in clean_entity_name and "name" in user_input.lower():
                ...
                if agent_node:
                    ...
                    if name_edge:
                        ...
                        if name_node_data:
                            structured_response = (
                                f"My name is {name_node_data.get('name').capitalize()}."
                            )
                        else:
                    ...
                    structured_response = (
                        "I don't seem to have a concept of myself right now."
                    )
            else:
                subject_node = self.graph.get_node_by_name(clean_entity_name)
                if not subject_node:
                    structured_response = (
                        f"I don't have any information about {entity_name}."
                    )
                else:
                    print(
            ...
            structured_response = (
                "I'm not sure how to process that. Could you rephrase?"
            )
